...
class CommentSearch extends Comments
{
    ...
    public function rules()
    {
        return [
            ...
            [['message', 'user.name', 'feedback.feedback', 'feedback'], 'safe'],
    ...
    {
        return array_merge(parent::attributes(), ['user.name', 'imgforcomments', 'feedback.feedback', 'feedback']); // TODO: Change the autogenerated stub
    }
    ...
    public function search($params)
    {
        ...
        $dataProvider->sort->attributes['feedback.feedback'] = [
            'asc' => ['feedback.feedback' => SORT_ASC],
            'desc' => ['feedback.feedback' => SORT_DESC],
        ...
        $query->andFilterWhere(['LIKE', 'user.name', $this->getAttribute('user.name')])
            ->andFilterWhere(['LIKE', 'feedback.feedback', $this->getAttribute('feedback.feedback')]);
